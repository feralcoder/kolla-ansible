...
1
  ...
  sudo cp $KOLLA_SETUP_DIR/../files/ceph-cinder-backup.conf /etc/kolla/config/cinder/cinder-backup.conf    || return 1
  sudo cp $KOLLA_SETUP_DIR/../files/ceph-cinder-volume.conf /etc/kolla/config/cinder/cinder-volume.conf    || return 1
  sudo cp $KOLLA_SETUP_DIR/../files/ceph-glance-api.conf /etc/kolla/config/glance/glance-api.conf    || return 1
  sudo cp $KOLLA_SETUP_DIR/../files/ceph-nova-compute.conf /etc/kolla/config/nova/nova-compute.conf    || return 1
  sudo cp $KOLLA_SETUP_DIR/../files/ceph-gnocchi.conf /etc/kolla/config/gnocchi/gnocchi.conf    || return 1
