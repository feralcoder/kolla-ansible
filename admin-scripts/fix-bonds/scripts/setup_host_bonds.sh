...
[[ -f ifcfg-bond3 ]] && cat ifcfg-bond1 | grep 'IP' | sed 's/192.168.127/172.19.4/g' >> ifcfg-bond3
[[ -f ifcfg-bond4 ]] && cat ifcfg-bond1 | grep 'IP' | sed 's/192.168.127/172.19.2/g' >> ifcfg-bond4
[[ -f ifcfg-bond5 ]] && cat ifcfg-bond1 | grep 'IP' | sed 's/192.168.127/172.19.3/g' >> ifcfg-bond5
[[ -f ifcfg-bond6 ]] && cat ifcfg-bond1 | grep 'IP' | sed 's/192.168.127/172.19.5/g' >> ifcfg-bond6
